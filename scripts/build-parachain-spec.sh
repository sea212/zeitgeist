...
PROD_CHAIN_NAME="Zeitgeist (slot swap)"
# For example, battery_station
PROD_CHAIN_PROTOCOL_ID="zeitgeist_kusama_slot_swap_v1"
# For example, battery_station_mainnet
PROD_CHAIN_ID="zeitgeist_kusama_slot_swap_v1"
# For example, battery_station_staging
STAGE_CHAIN="zeitgeist_staging"

cargo build --profile=release --bin zeitgeist --features parachain
